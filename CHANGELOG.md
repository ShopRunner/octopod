...
### Fixed
 ...
 - batch sizes of size 1 are now allowed for text models, but filtered for other models due to issues with with `nn.BatchNorm1d` failing on batches of size 1
